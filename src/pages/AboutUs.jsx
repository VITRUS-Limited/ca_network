...
export default function AboutUs() {
    return (
        ...
        <div className="max-w-7xl mx-auto px-10 sm:px-12 lg:px-14 pl-[max(1rem,env(safe-area-inset-left))] pr-[max(1rem,env(safe-area-inset-right))] py-16 text-left animate-fadeIn space-y-24">
            <FadeUpSection>
