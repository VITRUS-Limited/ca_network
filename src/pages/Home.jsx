    ...
    return (
        <div className="overflow-hidden">
            ...
            <section className="relative bg-[#034E72] text-white pt-16 pb-24 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-10 sm:px-12 lg:px-14 pl-[max(1rem,env(safe-area-inset-left))] pr-[max(1rem,env(safe-area-inset-right))] grid lg:grid-cols-12 gap-12 items-center">
            ...
            <section className="relative py-24 overflow-hidden min-h-150 flex items-center">
                ...
                {/* 🎯 加上 safe-area 與 responsive padding */}
                <div id="video-gallery" className="max-w-5xl mx-auto px-10 sm:px-12 lg:px-14 pl-[max(1rem,env(safe-area-inset-left))] pr-[max(1rem,env(safe-area-inset-right))] text-center relative z-10 text-white">
