    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-12 text-left animate-fadeIn space-y-14 bg-slate-50/50">
            ...
            <div className="max-w-5xl">
                ...
                <p className="text-s text-slate-500 text-balance md:text-lg leading-relaxed max-w-5xl">
            ...
            <div>
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white border border-slate-100 rounded-[28px] shadow-xs hover:shadow-xl hover:-translate-y-1.5 transition-all duration-500 ease-out flex flex-col overflow-hidden group">
            ...
            {/* ==================== 耀升國際營養師聯會 ==================== */}
            <div className="bg-white border border-slate-100 rounded-4xl shadow-xs overflow-hidden grid md:grid-cols-2 min-h-100 group hover:shadow-md transition-all duration-500">
            ...
            <div className="pt-2 space-y-6 relative">
                <div className="flex justify-between items-end">
                    <div className="space-y-3">
                        ...
                        <h3 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight">耀升國際營養師核心團隊</h3>
                    </div>
